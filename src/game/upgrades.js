...
export const UPGRADE_LIBRARY = [
  ...
  { id: "pushback", name: "Push Pulse", short: "+5 push force", description: "Adds pushback: +5 impulse on hit.", category: "projectile", rewardWeight: 0.8, color: "#ffd06c", icon: "P", shape: "diamond" },
